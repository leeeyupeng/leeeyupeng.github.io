...
lt::bresenhamline::bresenhamline(lt::Vector2<int> _a, lt::Vector3<float> _aColor, lt::Vector2<int> _b, lt::Vector3<float> _bColor) {
	a = _a;
	aColor = _aColor;
	b = _b;
	bColor = _bColor;
};
lt::bresenhamline::~bresenhamline() {
};
void lt::bresenhamline::Init() {
...
void lt::bresenhamline::Destroy() {
	glDeleteVertexArrays(1, &VAO);
	glDeleteBuffers(1, &VBO);
}
void lt::bresenhamline::Display() {
	glPointSize(1.0f);
	glBindVertexArray(VAO);
